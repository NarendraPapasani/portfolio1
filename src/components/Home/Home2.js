        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              My interests include building scalable{" "}
              <b className="purple">web applications</b> and exploring{" "}
              <b className="purple">modern technologies</b>.
              <br />
              <br />I enjoy creating innovative solutions using{" "}
              <b className="purple">React</b> and{" "}
              <b className="purple">Node.js</b>, and I am always eager to learn
              and implement new frameworks and libraries.
            </p>
          </Col>
